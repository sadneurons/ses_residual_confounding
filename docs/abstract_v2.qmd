---
title: "Underestimation of SES effects in large cohorts: A DAG‑informed simulation and NHANES case study"
author:
  - name: Ross A. Dunne
    affiliation: Greater Manchester Mental Health Foundation Trust
date: today
keywords: [causal inference, SES, selection bias, g-computation, simulation, NHANES]
format:
  pdf:
    pdf-engine: lualatex
    toc: false
